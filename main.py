...
class ResultsExport:
    ...
    def create_widgets(self):
        ...
        button_bg = "#004C99"
        # row 0 text
        self.heading_label = Label(self.parent_frame, text='Results/Export', font=("Arial", "8"), wraplength=350, bg=self.background)
        self.heading_label.grid(row=0, sticky="W")
        # row 1 text
        ...
        self.intro_label = Label(self.parent_frame, text=intro_txt, font=("Arial", "8"), wraplength=350, bg=self.background)
        ...
        self.text_label = Label(self.parent_frame, text=entry_txt, font=("Arial", "8"), wraplength=350, bg=self.background)
